...
console.log(deleteOne("a", true));
console.log(deleteOne("a", false));
...
function isTodayMyBirthday() {
  ...
  const birthday = new Date("2004-31-10");
...
// Esempio di utilizzo:
// isTodayMyBirthday() restituirà true se oggi è il tuo compleanno
...
function newestMovie(movies) {
  return movies.reduce((latest, movie) => {
    return movie.year > latest.year ? movie : latest;
  }, movies[0]);
}
...
const selectortd = function () {
  const esercio21 = document.querySelectorAll("td");
};
